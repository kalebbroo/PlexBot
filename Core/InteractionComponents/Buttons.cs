...
public class Buttons(ILogger<Buttons> logger, SlashCommands commands, LavaLinkCommands lavaLink) : InteractionModuleBase<SocketInteractionContext>
{
    ...
    public async Task HandleQueueInteraction(string customId)
    {
        ...
        _logger.LogInformation("Queue Options Pressed: {action}", action);
